...
function Draft(){
    ...
    return (
        ...
        <div className="font-sans flex lg:gap-8 gap-1">
            <div className="lg:w-[572px] grid w-full place-items-center py-6 lg:px-1 text-center mt-32  dark:bg-neutral-900 bg-gray-100">
                ...
                <p className="text-base mb-6 dark:text-neutral-400">Start writing answers by finding questions to answer in Questions for You.</p>
            ...
            <div className="lg:block hidden w-56 py-4 px-4  h-40 dark:bg-neutral-800  dark:text-neutral-400 bg-[#fff] text-neutral-800">
                <h4 className="text-base m-0 font-medium dark:text-neutral-300 text-neutral-800">Add topics you know about</h4>
