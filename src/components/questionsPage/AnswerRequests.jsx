    ...
    return(
        ...
        <div className=" font-sans flex sm:gap-8 gap-1">
            <div className=" lg:w-[572px] grid place-items-center px-1 lg:py-6 lg:px-6 text-center w-full mt-32">
                ...
                <p className="text-base mb-6 dark:text-neutral-400">Ask for answers from other users by clicking Request Answer on a question. Requests you receive will show up here.</p>
            ...
            <div className="lg:w-56 lg:block hidden ml-8 p-4 h-40 dark:bg-neutral-800  dark:text-neutral-400 bg-[#fff] text-neutral-800">
