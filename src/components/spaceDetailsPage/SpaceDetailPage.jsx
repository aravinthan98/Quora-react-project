            ...
            <div className="lg:w-10/12 pt-4 lg:px-6 lg:mx-auto mx-0 w-full">
                <div className="flex">
                    ...
                    <div className="lg:w-[53%] lg:ml-8 w-full px-1">
                        <div className="flex p-4 mb-2 box-border rounded border border-solid dark:bg-neutral-800 dark:border-zinc-700 bg-white border-zinc-300">
                            <div>
                            ...
                            <div className="flex flex-col justify-around ml-4">
                                <div className="leading-normal font-bold text-xl dark:text-zinc-300 text-zinc-800">{channel.name}</div>
                        ...
                        <div className="flex text-slate-400 border-b border-solid  text-[13px] font-medium cursor-pointer dark:border-neutral-600 border-neutral-300">
                        ...
                        <div className="box-border  rounded mt-2 dark:bg-neutral-900">
                            {clickedTab==='Read'&&
                               posts.map((item)=>(
