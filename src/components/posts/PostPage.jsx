...
function PostPage({postData}){
    ...
    return(
        <div  key={postData.id}>
            <div className={`flex flex-col px-3 pt-3 rounded border border-solid  relative mb-3 transition-all duration-500 ease-in-out ${darkMode ? " bg-neutral-800 border-neutral-800 text-neutral-300" :  "bg-white border-gray-300 text-gray-950"}`}>
