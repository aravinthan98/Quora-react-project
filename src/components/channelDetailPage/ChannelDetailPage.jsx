...
function ChannelDetailPage(){
  ...
  const fetchChannelDetail=(id)=>{
    ...
    return(
        <div className="channel_detail-page h-full lg:mt-2 mt-24 w-full bg-gray-100 dark:bg-neutral-900">
          ...
          <div className="channel-detail-bottom-section lg:w-98 lg:mx-auto lg:px-6 mx-0 px-0 w-full">
            <div className="channel-detail-navbar-section lg:w-3/4 w-full flex dark:text-gray-300 dark:border-b dark:border-solid dark:border-neutral-700 text-gray-800 border-b border-solid border-neutral-300">          
            ...
            <div className={channelTab==="channel-post"?"lg:w-3/5 w-full mt-5 mx-0 bg-gray-100 dark:bg-neutral-900 dark:text-gray-300 ":"hidden"}>
