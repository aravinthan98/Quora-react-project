...
function AddAnswer({onClickModel,value,content,id}){
    ...
    return(
        ...
        >
        <div className="outline-none box-border lg:w-[55%] w-full lg:h-96 flex items-start flex-col rounded-lg border border-solid dark:bg-neutral-900 dark:text-zinc-300 dark:border-zinc-700 bg-white border-zinc-300">
            ...
            <div className="box-border lg:h-full w-full mb-1 px-4 flex flex-col justify-between dark:bg-neutral-900 bg-white">
                ...
                <textarea name="content" id="content" cols="30" rows="7" className="outline-none w-full dark:bg-neutral-900 bg-white" placeholder="Write Your answer" value={answerInput} onChange={(e)=>handleAnswerInput(e)}></textarea>
                </div>
                <div className="w-full flex justify-end mr-2.5 ml-auto border-t border-solid dark:border-gray-600 border-gray-200">   
